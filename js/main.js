...
function animation1() {
    ...
    uns1 =document.getElementById ('uns1'),
...
function animation20() {
    ...
    uns2.style.opacity = "0";
    learn.style.opacity = "0";
}
function animation3() {
    let button3 = document.getElementById ('button3'),
    ad3 = document.getElementById ('ad3'),
    uns3 =document.getElementById ('uns3'),
